          ...
          <div class="w-1/2">
            ...
            <input type="text" hidden value="{{$user['tel']}}" name="telefone_cliente">
              <label class="block text-sm">
                ...
                <input
                  type="text" disabled value="{{$user['nome']}}" name="nomec2"
              ...
              <label class="block text-sm">
                ...
                <input
                  type="text" disabled value=" {{$user['tel']}}" name="telefone_cliente2"
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  placeholder="Troca de tela"
                />
              </label>
      ...
      <div x-data="app()" x-init="[initDate(), getNoOfDays()]" x-cloak>
          <div class="container mx-auto-">
            ...
            <div class="flex items-center ">
              ...
              <p class="ml-10 text-xl text-gray-600 font-semibold dark:text-gray-400">Atividades planejadas</p>
            </div>
