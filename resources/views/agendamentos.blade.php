        ...
        <form action="{{route ("admin.storeAgendamento")}}" method="post" enctype="multipart/form-data">
          ...
          <label class="block text-sm">
            ...
            <label class="block text-sm">
              ...
              <input type="text" disabled value="{{$user['nome']}}" name="nomec2" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Troca de tela" />
            </label>

            <label class="block text-sm">
              <span class="text-gray-700 dark:text-gray-400">Telefone do cliente</span>
              <input type="text" disabled value=" {{$user['tel']}}" name="telefone_cliente2" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Troca de tela" />
            </label>
