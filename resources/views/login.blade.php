...
<div class="min-h-screen bg-gray-100 flex flex-col justify-center sm:py-12">
  <div class="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
    <form action="{{route("logar")}}" method="post">
          @csrf
          <h1 class="font-bold text-center text-2xl mb-5">Login Assistencia do Murilo</h1>  
          <div class="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
            <div class="px-5 py-7">
              <label class="font-semibold text-sm text-gray-600 pb-1 block">Login</label>
              <input type="text" name="login" class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" />
              <label class="font-semibold text-sm text-gray-600 pb-1 block">Senha </label>
              <input type="password" name="senha" class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" />
              ...
              <div class="grid grid-cols-2 gap-1">
                ...
                <div class="text-center sm:text-right  whitespace-nowrap">
                  <a href="" class="transition duration-200 mx-5 px-5 py-4 cursor-pointer font-normal text-sm rounded-lg text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-200 focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50 ring-inset">
                      ...
                      <span class="inline-block ml-1">Ajuda</span>
                  </a>
                </div>
              </div>
            </div>
              ...
              <div class="grid grid-cols-2 gap-1">
                <div class="text-center sm:text-left whitespace-nowrap">
                  <button class="transition duration-200 mx-5 px-5 py-4 cursor-pointer font-normal text-sm rounded-lg text-gray-500 hover:bg-gray-200 focus:outline-none focus:bg-gray-300 focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50 ring-inset">
                      ...
                      <a href="#"><span class="inline-block ml-1">Voltar para a home</span></a>
                  </button>
                </div>
              </div>
            </div>
