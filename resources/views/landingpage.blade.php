...
<body class="leading-normal tracking-normal text-gray-900" style="font-family: 'Source Sans Pro', sans-serif;">
	...
	<div class="h-screen pb-14 bg-right bg-cover" style="background-image: url(https://www.tailwindtoolbox.com/templates/bg.svg);">
		<!--Nav-->
		<div class="w-full container mx-auto p-6">

			<div class="w-full flex items-center justify-between">
				<a class="flex items-center text-indigo-400 no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
					<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-device-mobile-vibration" width="32" height="32" viewBox="0 0 24 24" stroke-width="1.5" stroke="#818CF8" fill="none" stroke-linecap="round" stroke-linejoin="round">
		...
		<div class="container pt-24 md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
			...
			<div class="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
				<h1 class="my-4 text-3xl md:text-5xl text-purple-800 font-bold leading-tight text-center md:text-left slide-in-bottom-h1">Seu celular quebrou? Não se preocupe</h1>
				<p class="leading-normal text-base md:text-2xl mb-8 text-center md:text-left slide-in-bottom-subtitle">A melhor assistência técnica de (sua cidade)</p>

				<p class="text-blue-400 font-bold pb-8 lg:pb-6 text-center md:text-left fade-in">Entre em contato:</p>
				<div class="flex w-full justify-center md:justify-start pb-24 lg:pb-0 fade-in">
					<span class="flex items-center col-span-3">
						<div>
							<a href="" type="submit" class="px-10 py-4 font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
								Entrar em contato
							</a>
						</div>
					</span>
			...
			<div class="w-full pt-16 pb-6 text-sm text-center md:text-left fade-in">
				<a class="text-gray-500 no-underline hover:no-underline" href="#">&copy; Assistência do Murilo</a>
			</div>
