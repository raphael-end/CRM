    ...
    <div class="flex flex-col flex-1 w-full">
      <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
        <div class="container flex items-center justify-between h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
          ...
          <!-- Search input -->
        <div class="flex justify-center flex-1 lg:mr-32" style="color: #002859;">
          <div class="relative w-full max-w-xl mr-6 focus-within:text-blue-900">
            ...
            <div class="flex">
              ...
              <button  style="background-color: #002859;" class="search-button" id="button-search">BUSCAR</button>
            </div>
          </div>
        </div>
          <!-- Mobile hamburger -->
